...
**1. clone the repo**
```bash
git clone https://github.com/Ritesh1840/puzzlecam.git
cd puzzlecam
```
...
if you try this i would genuinely love to see your photobooth strip. tag me **@Ritesh1840** — have fun with it!
